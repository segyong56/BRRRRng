    ...
    <section>
      <div className="mypage_section_box">
        ...
        <card className="list_card">
          ...
          <div className="card_content">
            <div className="list_box">
              <div id="label" className="label"><i className="fas fa-user-circle fa-5x" id="user-circle"></i></div>
        ...
        <card className="list_card">
          ...
          <div className="card_content">
            <div className="list_box">
              <div id="label" className="label"><i className="fas fa-car fa-5x"></i></div>
              <div className="content1">
                <table id="dash-table">
                ...
                <div className="carlist-area">
                  <div className="carlist-table">
                    <table id="dash-table">
                      <thead id="dash-thead">
                        <tr>
                          <th id="dash-th">ADDRESS</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td className="table-d" id="dash-td">서울특별시 금천구 시흥동 123-1</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                ...
                <div className="carlist-area">
                  <div className="carlist-table">
                    <table id="dash-table">
                      ...
                      <tbody>
                        <tr>
                          <td className="table-d" id="dash-td">아이오닉</td>
